 ...
 * The objective here is to write some contracts code that verifies a transaction to issue an {@link RecordedTradeState}.
 * As with the {@link RecordedTradeStateTests} uncomment each unit test and run them one at a time. Use the body of the tests and the
...
//            Arrays.asList("net.corda.samples.fxsettlement.contracts")
//    );
//
//    /**
//     * Task 1.
