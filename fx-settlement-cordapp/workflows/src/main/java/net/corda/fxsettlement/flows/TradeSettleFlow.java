...
public class TradeSettleFlow {
    ...
    public static class InitiatorFlow extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            Vault.Page results = getServiceHub().getVaultService().queryBy(RecordedTradeState.class, queryCriteria);
            StateAndRef inputStateAndRefToSettle = (StateAndRef) results.getStates().get(0);
            RecordedTradeState inputStateToSettle = (RecordedTradeState) ((StateAndRef) results.getStates().get(0)).getState().getData();
            ...
            Command<RecordedTradeContract.Commands.Settle> command = new Command<>(
                    new RecordedTradeContract.Commands.Settle(),
     ...
     */
    @InitiatedBy(TradeSettleFlow.InitiatorFlow.class)
    public static class Responder extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            UntrustworthyData<RecordedTradeState> counterpartyData = otherPartyFlow.receive(RecordedTradeState.class);
